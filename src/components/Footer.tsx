...
export default function Footer() {
  return (
    <footer className="footer p-10 z-10 bg-white text-base-content">
        <aside>
            ...
            <h1>Developers Meeting<br/>Meet with Developers<br/></h1>
            <div className='flex items-center justify-center justify-items-center'>
              <img width="24" height="24" src="https://img.icons8.com/material-rounded/24/github.png" alt="github"/>
              <a className="link link-hover" target='_blank' href='https://github.com/Loverveysel/Developers-Meeting'>Github Repistory</a>
            </div>
        </aside> 
        <nav>
